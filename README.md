...
<head>
    ...
    <title>Logeshwari J- Portfolio</title>
    <style>
        body {
...
<body>
    ...
    <header>
        ...
        <img src="480_2301111058227.jpg" alt="Logeshwari J" class="profile-picture">
    ...
    <section id="resume">
        <div class="section-content" style="text-align: center;">
            ...
            <a href="Blue and White Simple Photographer Resume" class="download-button">Download CV</a>
        </div>
    </section>
    ...
    <section id="contact">
        <div class="section-content">
            <h2>Contact Me</h2>
            <p>Email: <a href="jlogeshwari54@gmail.com">jlogeshwari54@gmail.com</a></p>
        </div>
    </section>

    <footer>
        <p>&copy; 2025 Logeshwari J. All Rights Reserved.</p>
    </footer>
